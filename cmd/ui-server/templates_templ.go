	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var4 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			for name := range pages {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 252, Col: 13}
				}
...
func pageTemplate(name string, def ui.UIDefinition) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var8 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 265, Col: 36}
			}
...
func pageContentTemplate(name string, def ui.UIDefinition) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 275, Col: 33}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 282, Col: 58}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 297, Col: 55}
		}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		case "button":
			if id, ok := props["id"].(string); ok {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 308, Col: 45}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 310, Col: 13}
				}
				...
				if text, ok := props["text"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 324, Col: 13}
					}
		...
		case "title":
			if id, ok := props["id"].(string); ok {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 331, Col: 45}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 333, Col: 13}
				}
				...
				var templ_7745c5c3_Var23 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "clicked")
				...
				if content, ok := props["content"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 337, Col: 16}
					}
		...
		case "text":
			if id, ok := props["id"].(string); ok {
				...
				templ_7745c5c3_Var25, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("component-%s", id))
				if templ_7745c5c3_Err != nil {
				...
				var templ_7745c5c3_Var27 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "clicked")
				...
				if content, ok := props["content"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 350, Col: 16}
					}
		...
		case "input":
			if id, ok := props["id"].(string); ok {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 357, Col: 45}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 359, Col: 13}
				}
				...
				var templ_7745c5c3_Var31 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "changed", templ.Raw("{value: this.value}"))
				...
				var templ_7745c5c3_Var32 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "focused")
				...
				var templ_7745c5c3_Var33 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "blurred")
				...
				if typ, ok := props["type"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 364, Col: 17}
					}
				...
				if placeholder, ok := props["placeholder"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 367, Col: 32}
					}
				...
				if value, ok := props["value"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 370, Col: 20}
					}
				...
				if name, ok := props["id"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 376, Col: 18}
					}
		...
		case "textarea":
			if id, ok := props["id"].(string); ok {
				...
				templ_7745c5c3_Var38, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("component-%s", id))
				if templ_7745c5c3_Err != nil {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 386, Col: 13}
				}
				...
				var templ_7745c5c3_Var40 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "changed", templ.Raw("{value: this.value}"))
				...
				var templ_7745c5c3_Var41 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "focused")
				...
				var templ_7745c5c3_Var42 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "blurred")
				...
				if rows, ok := props["rows"].(int); ok {
					...
					templ_7745c5c3_Var43, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(rows))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 391, Col: 30}
					}
				...
				if cols, ok := props["cols"].(int); ok {
					...
					templ_7745c5c3_Var44, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprint(cols))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 394, Col: 30}
					}
				...
				if placeholder, ok := props["placeholder"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 397, Col: 32}
					}
				...
				if value, ok := props["value"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 402, Col: 14}
					}
		...
		case "checkbox":
			if id, ok := props["id"].(string); ok {
				...
				templ_7745c5c3_Var47, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("component-%s", id))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 409, Col: 45}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 413, Col: 14}
				}
				...
				var templ_7745c5c3_Var49 templ.ComponentScript = templ.JSFuncCall("sendUIAction", id, "changed", templ.Raw("{checked: this.checked}"))
				...
				if name, ok := props["name"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 416, Col: 19}
					}
				...
				if label, ok := props["label"].(string); ok {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 427, Col: 47}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 427, Col: 57}
					}
		...
		case "list":
			if typ, ok := props["type"].(string); ok {
				if id, ok := props["id"].(string); ok {
					...
					templ_7745c5c3_Var53, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("component-%s", id))
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 435, Col: 46}
					}
					...
					if title, ok := props["title"].(string); ok {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 437, Col: 31}
						}
						...
						if items, ok := props["items"].([]interface{}); ok {
							for _, item := range items {
								...
								case string:
									...
									if templ_7745c5c3_Err != nil {
										return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 446, Col: 16}
									}
						...
						if items, ok := props["items"].([]interface{}); ok {
							for _, item := range items {
								...
								case string:
									...
									templ_7745c5c3_Var56, templ_7745c5c3_Err = templ.JoinStringErrs(i)
									if templ_7745c5c3_Err != nil {
										return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 463, Col: 16}
									}
		...
		case "form":
			if id, ok := props["id"].(string); ok {
				...
				templ_7745c5c3_Var57, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("component-%s", id))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 479, Col: 45}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/ui-server/templates.templ`, Line: 481, Col: 13}
				}
				...
				var templ_7745c5c3_Var59 templ.ComponentScript = templ.JSUnsafeFuncCall("event.preventDefault(); sendUIAction('" + id + "', 'submitted')")
...
func uiUpdateTemplate() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = base("Dynamic UI").Render(templ.WithChildren(ctx, templ_7745c5c3_Var61), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return templ_7745c5c3_Err
